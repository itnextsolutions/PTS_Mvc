...
namespace MVC_BugTracker.Services
{
    public class BTNotificationService : IBTNotificationService
    {
        ...
        public async Task AdminsNotificationAsync(Notification notification, int companyId)
        {
            ...
            {
                // Get company admins
                //List<BTUser> admins = await _infoService.GetMembersInRoleAsync("Admin", companyId,"v");
                List<BTUser> admins = await _infoService.GetMembersInRoleAsyncAdmin("Admin", companyId);
